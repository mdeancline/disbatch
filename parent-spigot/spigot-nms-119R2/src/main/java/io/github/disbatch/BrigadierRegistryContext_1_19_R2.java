...
class BrigadierRegistryContext_1_19_R2 implements BrigadierRegistryContext {
    @Override
    public BrigadierRegistry getRegistry() {
        return new BrigadierRegistryImpl(((CraftServer) Bukkit.getServer()).getServer().aB().a());
    }
