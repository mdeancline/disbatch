...
class BrigadierRegistryContext_1_20_R1 implements BrigadierRegistryContext {
    @Override
    public BrigadierRegistry getRegistry() {
        return new BrigadierRegistryImpl(((CraftServer) Bukkit.getServer()).getServer().aC().a());
    }
