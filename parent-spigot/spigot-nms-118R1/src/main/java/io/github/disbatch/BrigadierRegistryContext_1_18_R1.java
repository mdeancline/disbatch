...
class BrigadierRegistryContext_1_18_R1 implements BrigadierRegistryContext {
    @Override
    public BrigadierRegistry getRegistry() {
        return new BrigadierRegistryImpl(((CraftServer) Bukkit.getServer()).getServer().aA().a());
    }
