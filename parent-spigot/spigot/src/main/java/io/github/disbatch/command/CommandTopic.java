...
/**
 * Holds information about a {@link io.github.disbatch.Command} that should be displayed to a {@link CommandSender} when executing Spigot's
 * {@code /help} command.
 *
...
public interface CommandTopic<S extends CommandSender> {
    ...
    void apply(io.github.disbatch.Command command);
